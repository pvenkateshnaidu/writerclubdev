...
function getAuthServiceConfigs() {
    let config = new angular_6_social_login__WEBPACK_IMPORTED_MODULE_32__["AuthServiceConfig"]([
        {
...
let GroupsComponent = class GroupsComponent {
    constructor(fb, alertService, router, http, categoriesService) {
        this.fb = fb;
        this.alertService = alertService;
        this.router = router;
        this.http = http;
        ...
        this.commaSepEmail = (control) => {
            ...
            const forbidden = emails.some(email => _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email(new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](email)));
    ...
    removeMember(id) {
        this.loading = true;
        this.categoriesService.removeMember(id).subscribe((res) => {
            console.log(res);
            this.loading = false;
    ...
    removeGroup(id) {
        this.loading = true;
        this.categoriesService.removeGroup(id).subscribe((res) => {
            console.log(res);
            this.loading = false;
            // this.router.navigate(['/myprofile']);
            this.getAllGroups();
    ...
    createGroupMembers() {
        // alert(this.id)
        this.loading = true;
        this.categoriesService.createGroupMember(this.sendEmailForm.value).subscribe((res) => {
            this.loading = false;
    ...
    getGroupMembers() {
        ...
        let currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.loading = true;
        this.categoriesService.getGroupMembers(currentUser.id).subscribe((res) => {
    ...
    create() {
        ...
        this.categoriesService.createGroupmemberships(this.createGroup.value).subscribe((res) => {
    ...
    getAllGroups() {
        ...
        let currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.loading = true;
        this.categoriesService.getAllGroups(currentUser.id).subscribe((res) => {
...
let HomeComponent = class HomeComponent {
    constructor(userService, category, authService) {
    ...
    ngOnInit() {
        let self = this;
        let code = '';
        this.category.getCounByStoryCount(code).subscribe(data => {
            self.value = data;
    ...
    getCateg() {
        this.category.getToken().subscribe(data => {
            this.loading = true;
            //  alert(this.token);
            this.token = data;
            this.category.getAllC(this.token.access_token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])()).subscribe(cats => {
                this.cats = cats;
            });
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, route, userService, socialAuthService, router, authenticationService, category, alertService) {
    ...
    getCateg() {
        this.category.getToken().subscribe(data => {
            // alert(this.token);
            this.token = data;
            this.category.getAllC(this.token.access_token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(cats => {
                this.cats = cats;
            });
        });
    }
...
ImageSnippet.ctorParameters = () => [
    { type: String },
    { type: File }
];
let MyProfileComponent = class MyProfileComponent {
    constructor(formBuilder, alertService, imageService, userService, http) {
        this.formBuilder = formBuilder;
        this.alertService = alertService;
    ...
    getById() {
        ...
        this.userService.getById(id).subscribe((res) => {
            ...
            this.myprofile = this.formBuilder.group({
                name: [this.getusers.name, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
                dob: [this.getusers.DOB, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
                email: [this.getusers.email, [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)]],
                mobile_number: [this.getusers.mobile_number, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required],
            });
            //  this.imgURL=this.getusers.profile_path;
            // this.router.navigate(['/myprofile']);
        }, (err) => {
...
let MyStoriesComponent = class MyStoriesComponent {
    constructor(categoriesService, userService, router, http) {
        this.categoriesService = categoriesService;
        this.userService = userService;
        this.router = router;
        this.http = http;
    ...
    sendmailGroup(groupid, storyid) {
        this.loading = true;
        this.categoriesService.sendmailGroup(groupid, storyid).subscribe((res) => {
            console.log(res);
            this.onCloseHandled();
            this.loading = false;
            // this.router.navigate(['/myprofile']);
    ...
    getAllStories() {
        let currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.loading = true;
        this.categoriesService.getStoriesById(currentUser.id).subscribe((res) => {
...
let RegisterComponent = class RegisterComponent {
    constructor(formBuilder, router, userService, alertService, category) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.userService = userService;
        this.alertService = alertService;
...
let SelectYourStoryComponent = class SelectYourStoryComponent {
    constructor(formBuilder, alertService, imageService, userService, router, http) {
        this.formBuilder = formBuilder;
        this.alertService = alertService;
        this.imageService = imageService;
        this.userService = userService;
    ...
    getCateg() {
        this.imageService.getToken().subscribe(data => {
            this.loading = true;
            //  alert(this.token);
            this.token = data;
            this.imageService.getAllC(this.token.access_token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])()).subscribe(cats => {
                let all = cats;
                this.allcat = cats;
                this.cats = all.data;
...
SelectYourStoryComponent.ctorParameters = () => [
...
let SingleStoryComponent = class SingleStoryComponent {
    constructor(route, router, userService, categoriesService, _location, http) {
        this.route = route;
        this.router = router;
        this.userService = userService;
        this.categoriesService = categoriesService;
    ...
    getStory() {
        ...
        // alert(this.id)
        this.loading = true;
        this.categoriesService.getStory(this.id).subscribe((res) => {
            this.loading = false;
...
SingleStoryComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_5__["UserService"] },
    { type: _services_categories_service__WEBPACK_IMPORTED_MODULE_4__["CategoriesService"] },
...
let StoryFeedComponent = class StoryFeedComponent {
    constructor(categoriesService, userService, router, http) {
        this.categoriesService = categoriesService;
        this.userService = userService;
        this.router = router;
    ...
    getAllStories() {
        this.loading = true;
        this.categoriesService.getStories().subscribe((res) => {
            this.allstories = res.data;
            console.log(this.allstories);
            this.loading = false;
            // this.router.navigate(['/myprofile']);
...
StoryFeedComponent.ctorParameters = () => [
    { type: _services_categories_service__WEBPACK_IMPORTED_MODULE_2__["CategoriesService"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_5__["UserService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
...
let WriteStoryComponent = class WriteStoryComponent {
    ...
    onChange(cat, isChecked) {
        const emailFormArray = this.writestory.controls.cat_id;
        if (isChecked) {
    ...
    onSubmit(event) {
        ...
        this.imageService.createStory(formData).subscribe((res) => {
            this.loading = false;
...
WriteStoryComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_7__["AlertService"] },
    { type: _services_categories_service__WEBPACK_IMPORTED_MODULE_2__["CategoriesService"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_7__["UserService"] },
